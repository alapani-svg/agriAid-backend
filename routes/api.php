...
Route::apiResource('buyer-requests', BuyerRequestController::class)->only([
    'index',
    'store',
]);

Route::post('buyer-requests/{buyer_request}/quote', [BuyerRequestController::class, 'quote']);
Route::post('buyer-requests/{buyer_request}/buyer-accept', [BuyerRequestController::class, 'buyerAccept']);
Route::post('buyer-requests/{buyer_request}/buyer-reject', [BuyerRequestController::class, 'buyerReject']);
Route::post('buyer-requests/{buyer_request}/farmer-approve', [BuyerRequestController::class, 'farmerApprove']);
Route::post('buyer-requests/{buyer_request}/farmer-reject', [BuyerRequestController::class, 'farmerReject']);
