...
<head>
    ...
    <style>
        * { font-family: DejaVu Sans, sans-serif; }
        ...
        .logo { width: 56px; height: 56px; background: linear-gradient(135deg, #026e00 0%, #00b300 100%); border-radius: 16px; display: flex; align-items: center; justify-content: center; color: white; font-size: 28px; font-weight: 900; box-shadow: 0 4px 12px rgba(2,110,0,0.3); position: relative; }
        .logo::after { content: '🌿'; position: absolute; top: -6px; right: -4px; font-size: 14px; }
